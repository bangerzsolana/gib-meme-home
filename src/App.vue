...
@media (min-width: 768px) {
  ...
  .fan-left-0 { transform: rotate(-10deg); z-index: 1; }
  .fan-left-1 { transform: rotate(8deg);   z-index: 2; }
  .fan-left-2 { transform: rotate(26deg);  z-index: 3; }
  ...
  .fan-right-0 { transform: rotate(-26deg); z-index: 3; }
  .fan-right-1 { transform: rotate(-8deg);  z-index: 2; }
  .fan-right-2 { transform: rotate(10deg);  z-index: 1; }
